...
public class Reslut : MonoBehaviour
{
    ...
    public TextMeshProUGUI bousText;
    public TextMeshProUGUI RankText;
    public TextMeshProUGUI Price;
    [SerializeField] GameObject ReslutObject;
    ...
    {
        bousText.text += $"ボーナス: {weapon.bonus}\n";
        ...
        SowrdImage.sprite = weapon.weapon.WeaponImage;//剣の画像
    ...
    //        SowrdImage.sprite = weaponData.WeaponImage; // 剣の画像
