...
namespace CommonUI
{
    public class GridView<TCell, TItemData> : FancyGridView<TItemData, Context>
    where TCell : FancyGridViewCell<TItemData, Context>
    where TItemData : class
    {
        protected class CellGroup : DefaultCellGroup { }

        [SerializeField] protected TCell cellPrefab = default;
